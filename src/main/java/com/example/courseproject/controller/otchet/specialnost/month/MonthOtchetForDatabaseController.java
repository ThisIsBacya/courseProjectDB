package com.example.courseproject.controller.otchet.specialnost.month;
...
public class MonthOtchetForDatabaseController {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * from getotchetfrommonthforspecdatabase");
