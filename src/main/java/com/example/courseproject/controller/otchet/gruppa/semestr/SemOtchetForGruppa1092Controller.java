...
public class SemOtchetForGruppa1092Controller {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * from getotchetfromsemestrforgruppa1092");
