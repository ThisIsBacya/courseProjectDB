package com.example.courseproject.controller.otchet.kurs.month;
...
public class MonthOtchetForSecondKursController {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * FROM getotchetfrommonthforsecondkurs");
