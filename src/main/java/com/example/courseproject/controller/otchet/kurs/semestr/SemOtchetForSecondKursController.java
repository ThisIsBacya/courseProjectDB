package com.example.courseproject.controller.otchet.kurs.semestr;
...
public class SemOtchetForSecondKursController {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * FROM getotchetfromsemestrforsecondkurs");
