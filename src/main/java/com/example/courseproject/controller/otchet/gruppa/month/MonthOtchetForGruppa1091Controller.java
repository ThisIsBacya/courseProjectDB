...
public class MonthOtchetForGruppa1091Controller {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * from getotchetfrommonthforgruppa1091");
