package com.example.courseproject.controller.otchet.specialnost.semestr;
...
public class SemOtchetForDatabaseController {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * from getotchetfromsemestrforspecdatabase");
