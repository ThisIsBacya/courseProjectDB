...
public class SemOtchetForGruppa0091Controller {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * from getotchetfromsemestrforgruppa0091");
