...
public class MonthOtchetForFourthKursController {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * FROM getotchetfrommonthforfourthkurs");
