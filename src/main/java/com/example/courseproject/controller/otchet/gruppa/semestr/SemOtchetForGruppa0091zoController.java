package com.example.courseproject.controller.otchet.gruppa.semestr;
...
public class SemOtchetForGruppa0091zoController {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * from getotchetfromsemestrforgruppa0091zo");
