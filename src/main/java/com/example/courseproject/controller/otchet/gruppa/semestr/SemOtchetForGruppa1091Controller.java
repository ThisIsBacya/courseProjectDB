...
public class SemOtchetForGruppa1091Controller {
    @FXML
    ...
    private void showData() {
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT * from getotchetfromsemestrforgruppa1091");
